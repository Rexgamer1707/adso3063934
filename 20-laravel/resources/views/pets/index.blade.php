...
<div class="join bg-[#000a] max-auto rounded-box">
    <a href="{{ route('pets.create') }}" class="btn btn-outline btn-success text-white border-green-500 hover:bg-green-600 hover:border-green-600 join-item">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
            <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm48-88a8,8,0,0,1-8,8H136v32a8,8,0,0,1-16,0V136H88a8,8,0,0,1,0-16h32V88a8,8,0,0,1,16,0v32h32A8,8,0,0,1,176,128Z"></path>
        </svg>
        <span class="hidden md:inline">Add Pet</span>
    </a>
    <a class="btn btn-outline text-white hover:bg-[#000a] hover:text-white join-item" href="{{ url('export/pets/pdf') }}">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
    ...
    <a class="btn btn-outline text-white hover:bg-[#000a] hover:text-white join-item" href="{{ url('export/pets/excel') }}">
        <svg xmlns=" http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <tbody class="datalist">
            ...
            <tr class="{{ $pet->id % 2 == 0 ? 'bg-[#000a]' : '' }}">
                ...
                <td>
                    ...
                    <a class="btn btn-outline btn-success btn-xs text-white border-green-500 hover:bg-green-600 hover:border-green-600" href="{{ url('pets/' . $pet->id . '/edit') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" viewBox="0 0 256 256">
